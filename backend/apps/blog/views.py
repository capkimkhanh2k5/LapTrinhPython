...
class PostViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        # Service logic could be moved here but serializer.save() is standard for simple CRUD.
        # However, we can use service for consistency if needed.
        # For now, sticking to serializer save with author injection.
